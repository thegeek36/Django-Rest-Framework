...
from .serializer import StudentSerializer,CreateStudentSerializer
...
def create(request): 
    ...
    if request.method == 'POST':
        ...
        serializer = CreateStudentSerializer(data = pythondata)
...
def student_api(request):
    ...
    if request.method == 'PUT':   
        ...
        id = data.get('id')
        stu = Student.objects.get(id = id)
        serializer = CreateStudentSerializer(stu,data = data,partial  = True)
        if serializer.is_valid():
            serializer.save()
